...
st.markdown("""
    **Impervious surface | $A_{IMP}$ = 0.0075/%** For each percent additional concrete/asphalt in a given area, the simulation adds 0.0075°C.  
    ...
    **Green roofs | $A_{GROOF}$ = 0.003/%** Green roofs introduce cooling on the rooftop level. While they are powerful with evapotranspiration and more reflective leaves, their soil traps and releases heat into the night.  
    **Albedo | $A_{ALB}$ = 6.1** Albedo is measured on a scale of 0 to 1, or 0% to 100% of light absorbed. This coefficient highlights the 6.1°C range across the albedo scale.  
    """)
